...
<div class="contenedor">
    ...
    <div class="contenedor-alternativa">
        ...
        <div class="caja" draggable="true" ondragstart="drag(event)" id="a">27</div>
        <div class="caja" draggable="true" ondragstart="drag(event)" id="b">18</div>
